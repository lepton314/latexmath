def parse_element(element, parsed_elements):
    ...
    # 関数
        ...
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mi', 'name': 'arccos'})
    elif '\\arcsin' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mi', 'name': 'arcsin'})
    elif '\\arctan' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mi', 'name': 'arctan'})
    elif '\\arg' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mi', 'name': 'arg'})
    elif '\\cos' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mi', 'name': 'cos'})
    elif '\\csh' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mi', 'name': 'csh'})
    elif '\\cot' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mi', 'name': 'cot'})
    elif '\\coth' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mi', 'name': 'coth'})
    elif '\\csc' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mi', 'name': 'csc'})
    elif '\\deg' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mi', 'name': 'deg'})
    elif '\\det' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mi', 'name': 'det'})
    elif '\\dim' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mi', 'name': 'dim'})
    elif '\\exp' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mi', 'name': 'exp'})
    elif '\\gcd' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mi', 'name': 'gcd'})
    elif '\\hom' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mi', 'name': 'hom'})
    elif '\\inf' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mo', 'name': 'inf', 'type': 'underover'})
    elif '\\ker' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mi', 'name': 'ker'})
    elif '\\lg' == element:
        parsed_elements.append({'mode': 'function', 'tag': 'mi', 'name': 'lg'})
    elif '\\lim' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mo', 'name': 'lim', 'type': 'underover'})
    elif '\\liminf' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mo', 'name': 'liminf', 'type': 'underover'})
    elif '\\limsup' == element:
        parsed_elements.append(
            {'mode': 'function', 'name': 'limsup', 'type': 'underover'})
    elif '\\ln' == element:
        ...
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mo', 'name': 'max', 'type': 'underover'})
    elif '\\min' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mo', 'name': 'min', 'type': 'underover'})
    elif '\\Pr' == element:
        parsed_elements.append({'mode': 'function', 'tag': 'mi', 'name': 'Pr'})
    elif '\\sec' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mi', 'name': 'sec'})
    elif '\\sin' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mi', 'name': 'sin'})
    elif '\\sinh' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mi', 'name': 'sinh'})
    elif '\\sup' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mo', 'name': 'sup', 'type': 'undercover'})
    elif '\\tan' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mi', 'name': 'tan'})
    elif '\\tanh' == element:
        parsed_elements.append(
            {'mode': 'function', 'tag': 'mi', 'name': 'tanh'})
    # 演算子2
    elif '+' == element:
    ...
    # 演算子3
        ...
        parsed_elements.append(
            {'mode': 'operator3', 'tag': 'mo', 'name': '\u2211', 'type': 'underover'})
    elif '\\prod' == element:
        parsed_elements.append(
            {'mode': 'operator3', 'tag': 'mo', 'name': '\u220F', 'type': 'underover'})
    elif '\\bigcap' == element:
    ...
    # 特殊文字
        ...
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03B1'})
    elif '\\beta' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03B2'})
    elif '\\gamma' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03B3'})
    elif '\\delta' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03B4'})
    elif '\\epsilon' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03B5'})
    elif '\\varepsilon' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u025B'})
    elif '\\zeta' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03B6'})
    elif '\\eta' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03B7'})
    elif '\\theta' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03B8'})
    elif '\\vartheta' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03D1'})
    elif '\\iota' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03B9'})
    elif '\\kappa' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03BA'})
    elif '\\lambda' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03BB'})
    elif '\\mu' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03BC'})
    elif '\\nu' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03BD'})
    elif '\\xi' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03BE'})
    elif '\\pi' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03C0'})
    elif '\\varpi' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03D6'})
    elif '\\rho' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03C1'})
    elif '\\varrho' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03F1'})
    elif '\\varsigma' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03C2'})
    elif '\\sigma' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03C3'})
    elif '\\tau' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03C4'})
    elif '\\upsilon' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03C5'})
    elif '\\phi' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03C6'})
    elif '\\varphi' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03D5'})
    elif '\\chi' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03C7'})
    elif '\\psi' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03C8'})
    elif '\\omega' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mi', 'name': '\u03C9'})
    elif '\\Gamma' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mo', 'name': '\u0393'})
    elif '\\Delta' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mo', 'name': '\u0394'})
    elif '\\Theta' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mo', 'name': '\u0398'})
    elif '\\Lambda' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mo', 'name': '\u039B'})
    elif '\\Xi' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mo', 'name': '\u039E'})
    elif '\\Pi' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mo', 'name': '\u03A0'})
    elif '\\Sigma' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mo', 'name': '\u03A3'})
    elif '\\Upsilon' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mo', 'name': '\u03A5'})
    elif '\\Phi' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mo', 'name': '\u03A6'})
    elif '\\Psi' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mo', 'name': '\u03A8'})
    elif '\\Omega' == element:
        parsed_elements.append(
            {'mode': 'greek', 'tag': 'mo', 'name': '\u03A9'})
    # 分数
    elif '\\frac12' == element:
    ...
    # 英数字
        ...
        parsed_elements.append(
            {'mode': 'number', 'tag': 'mn', 'name': element})
    else:
        parsed_elements.append(
            {'mode': 'characters', 'tag': 'mi', 'name': element})
